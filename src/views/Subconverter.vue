...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "clashsub-six.vercel.app (自动编译最新版本后端-测试）": "https://clashsub-six.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://clashsub-six.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://clashsub-six.vercel.app/sub?";
